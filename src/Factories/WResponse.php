...
class WResponse  {
    ...
    */
     ...
     * Ha a folyamat nem terminált, vagy a válasz nem megszerezhető, a válasz hamis.
     *
    ...
    /***************
     * Igaz, ha a tranzakció-futás befejeződött.
     ...
     *
     * @return boolean igaz, ha a tranzaktálás befejeződött
     */
    function isFinished() {
    ...
    /***************
     * A folyamat-példány sikeres befejeződésének megállapítása
     * A folyamat sikeresen terminált, ha a válasz <messagelist> részében szerepel
     * a SIKER üzenet.
     * Ha a folyamat nem terminált, vagy a válasz nem megszerezhető, a válasz hamis.
     *
     * @return boolean a sikeresség jelzője
     */
    ...
    /***************
     * A végrehajtáshoz tartozó válasz xml, a megfelelő value object reprezentációban
     *
