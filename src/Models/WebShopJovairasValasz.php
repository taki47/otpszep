...
class WebShopJovairasValasz {
    ...
    * Sikeres jóváírás esetén egy háromjegyű numerikus kód a 000-010 értéktartományból. 
    * Sikertelen vásárlás esetén, amennyiben a hiba (vagy elutasítás) a jóváírás művelete során történik 
    ...
    * Az adat a kártyavezető rendszer válasza a  jóváíráshoz tartozó kártyajóváírási művelethez, 
    * egyfajta azonosító / hitelesítő kód, s mint ilyen, a bolt is megkapja válaszadatként.
    */
