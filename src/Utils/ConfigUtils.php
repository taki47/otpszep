...
class ConfigUtils {
    ...
    *   (arra az esetre, ha nem létezik a megfelelő paraméter)
    * @return mixed a paraméter értéke string vagy $defaultValue-val megegyező típusban
    */
    ...
    /**
    * @desc Logikai értékű konfigurációs paraméter kiolvasása simpleshop
    * vagy multishop környezet szerint kialakított
    * .config állományból
    * 
    * @param Array $config az konfigurációs fájl tartalma
    ...
    */
    ...
    /**
    * @desc A Java-ra jellemző konfigurációs paraméter helyettesítés 
    * megvalósítása: a $paramValue string-ben szereplő {key} értékek
